...
const styles = StyleSheet.create({
  ...
  heroCard: { backgroundColor: THEME.colors.surface, borderRadius: THEME.radius.lg, padding: 20, marginBottom: 16, borderWidth: 1, borderColor: THEME.colors.border },
  ...
  statusBadge: { alignSelf: 'flex-start', paddingHorizontal: 12, paddingVertical: 4, borderRadius: THEME.radius.full },
  statusText: { fontSize: 13, fontWeight: '600' },
  rentCard: { backgroundColor: THEME.colors.brand, borderRadius: THEME.radius.lg, padding: 20, marginBottom: 16 },
  ...
  rentAmount: { fontSize: 28, fontWeight: '700', color: THEME.colors.textInverse },
  rentFrequency: { fontSize: 13, color: 'rgba(255,255,255,0.7)' },
  rentDueInfo: { alignItems: 'flex-end' },
  rentDueDays: { fontSize: 16, fontWeight: '700', color: THEME.colors.textInverse },
  ...
  detailsGrid: { backgroundColor: THEME.colors.surface, borderRadius: THEME.radius.md, padding: 16, borderWidth: 1, borderColor: THEME.colors.border },
  ...
  increaseCard: { backgroundColor: THEME.colors.surface, borderRadius: THEME.radius.md, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: THEME.colors.border },
  ...
  actionCard: { width: '47%', backgroundColor: THEME.colors.surface, borderRadius: THEME.radius.md, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: THEME.colors.border },
