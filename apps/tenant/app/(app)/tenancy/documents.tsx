...
const styles = StyleSheet.create({
  ...
  docRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: THEME.colors.surface, borderRadius: 12, padding: 16, marginBottom: 10, borderWidth: 1, borderColor: THEME.colors.border },
  docIcon: { width: 40, height: 40, borderRadius: 10, backgroundColor: `${THEME.colors.brand}10`, alignItems: 'center', justifyContent: 'center', marginRight: 12 },
